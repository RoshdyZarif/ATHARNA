...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _resetPassword(LanguageService langService) async {
    final email = _emailController.text.trim();
    if (email.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppTranslations.get('enter_email', langService.currentLanguage))),
      );
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppTranslations.get('reset_link_sent', langService.currentLanguage)),
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(AppTranslations.get('login', langService.currentLanguage)),
          leading: IconButton(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                      alignment: langService.isArabic ? Alignment.centerLeft : Alignment.centerRight,
                      child: TextButton(
                        onPressed: () => _resetPassword(langService),
                        child: Text(
                          AppTranslations.get('forgot_password', langService.currentLanguage),
                    ...
                    Row(
                      ...
                      children: [
                        Text(AppTranslations.get('dont_have_account', langService.currentLanguage)),
                        TextButton(
